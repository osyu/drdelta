scr_get_valid_room = function(argument0, argument1, argument2)
{
    ...
    if (!is_valid)
        show_debug_message(("trying to load invalid room: " + string(room_get_name((current_room.room_index - 1)))))
