scr_84_init_localization_ch1 = function()
{
    ...
    if (global.lang_loaded != global.lang)
    {
        ...
        if (global.lang == "ja")
        {
            ...
            ds_map_add(sm, "spr_bnamekris", 4048)
            ds_map_add(sm, "spr_bnameralsei", 4049)
            ds_map_add(sm, "spr_bnamesusie", 4050)
            ds_map_add(sm, "spr_btact", 4051)
            ds_map_add(sm, "spr_btdefend", 4052)
            ds_map_add(sm, "spr_btfight", 4053)
            ds_map_add(sm, "spr_btitem", 4054)
            ds_map_add(sm, "spr_btspare", 4056)
            ds_map_add(sm, "spr_bttech", 4055)
            ds_map_add(sm, "spr_darkmenudesc", 4190)
            ds_map_add(sm, "spr_dmenu_captions", 4168)
            ds_map_add(sm, "spr_quitmessage", 4383)
            ds_map_add(sm, "spr_thrashbody_b", 4097)
            ds_map_add(sm, "spr_thrashfoot_b", 4095)
            ds_map_add(sm, "spr_thrashlogo", 4101)
            ds_map_add(sm, "spr_thrashstats", 4111)
        ...
        else
        {
            ...
            ds_map_add(sm, "spr_bnamekris", 4027)
            ds_map_add(sm, "spr_bnameralsei", 4028)
            ds_map_add(sm, "spr_bnamesusie", 4029)
            ds_map_add(sm, "spr_btact", 4030)
            ds_map_add(sm, "spr_btdefend", 4032)
            ds_map_add(sm, "spr_btfight", 4033)
            ds_map_add(sm, "spr_btitem", 4037)
            ds_map_add(sm, "spr_btspare", 4034)
            ds_map_add(sm, "spr_bttech", 4039)
            ds_map_add(sm, "spr_darkmenudesc", 4179)
            ds_map_add(sm, "spr_dmenu_captions", 4165)
            ds_map_add(sm, "spr_quitmessage", 4285)
            ds_map_add(sm, "spr_thrashbody_b", 4096)
            ds_map_add(sm, "spr_thrashfoot_b", 4094)
            ds_map_add(sm, "spr_thrashlogo", 4100)
            ds_map_add(sm, "spr_thrashstats", 4103)
