...
if (con == 2 && customcon == 0)
{
    ...
    if shortened
    {
        con = 11
        tempcon = 0
        c_var_instance(coaster_berdly, "character_sprite", 1843)
    ...
    else
    {
        ...
        c_var_instance(coaster_ralsei, "character_sprite", 783)
        c_speaker("ralsei")
        ...
        c_talk_wait()
        c_var_instance(coaster_ralsei, "character_sprite", 793)
        c_sel(qu)
        ...
        c_wait(10)
        c_var_instance(coaster_susie, "character_sprite", 843)
        ...
        c_facenext("susie", "C")
        c_var_instance(coaster_susie, "character_sprite", 823)
...
if (con == 5)
{
    con = 6
    c_waitcustom_end()
    c_var_instance(coaster_susie, "character_sprite", 995)
    c_var_instance(coaster_ralsei, "character_sprite", 1506)
    c_speaker("berdly")
