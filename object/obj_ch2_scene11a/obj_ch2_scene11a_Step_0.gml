...
if (con == 2 && customcon == 0)
{
    ...
    if shortened
    {
        con = 11
        tempcon = 0
        c_var_instance(coaster_berdly, "character_sprite", 1849)
    ...
    else
    {
        ...
        c_var_instance(coaster_ralsei, "character_sprite", 785)
        c_speaker("ralsei")
        ...
        c_wait(10)
        c_var_instance(coaster_susie, "character_sprite", 845)
        ...
        c_wait(30)
        c_var_instance(coaster_noelle, "character_sprite", 722)
        c_speaker("noelle")
        ...
        c_facenext("susie", "C")
        c_var_instance(coaster_susie, "character_sprite", 825)
        ...
        c_talk_wait()
        c_mus("free")
        c_var_instance(coaster_berdly, "character_sprite", 684)
        ...
        c_var_instance(coaster_noelle, "character_sprite", 717)
        c_waitcustom()
    }
}
...
if (con == 5)
{
    con = 6
    c_waitcustom_end()
    c_var_instance(coaster_susie, "character_sprite", 997)
    c_var_instance(coaster_ralsei, "character_sprite", 1510)
    c_speaker("berdly")
    ...
    c_var_instance(coaster_ralsei, "character_sprite", 796)
    c_mus("free_all")
    ...
    c_talk_wait()
    c_var_instance(coaster_berdly, "character_sprite", 695)
    c_speaker("berdly")
    ...
    c_talk_wait()
    c_var_instance(coaster_berdly, "character_sprite", 674)
    ...
    c_talk_wait()
    c_var_instance(coaster_berdly, "character_sprite", 668)
    c_var_instance(coaster_berdly, "animate", 0)
    c_speaker("berdly")
    ...
    c_sprite(spr_queen_chair_flame_side)
    c_wait(10)
    c_var_instance(coaster_berdly, "character_sprite", 670)
    c_speaker("ralsei")
...
if (con == 10)
{
    ...
    c_var_instance(coaster_berdly, "character_sprite", 665)
    c_var_instance(coaster_berdly, "character_offset_x", -52)
