...
if (con == 1)
{
    ...
    c_facing("d")
    c_emote("!", 30)
    c_script_instance(kr_actor, gml_Script_scr_afterimage, 3)
    c_var_lerp_instance(kr_actor, "x", kr_actor.x, (camerax() + 100), 30, 1)
    c_wait_box(2)
    c_script_instance_stop(kr_actor, gml_Script_scr_afterimage)
    c_facing("l")
    ...
    c_emote("!", 30, 0)
    c_sel(kr)
    c_script_instance(id, gml_Script_snd_play_pitch, 25, 56, (0.5 + random(1.2)))
    c_shakestep_x(15, -4, 15, 25, 5, 1)
    c_wait(150)
    c_script_instance_stop(id, gml_Script_snd_play_pitch)
    c_shakestep(-15, 0)
    c_wait(30)
    c_flip("y")
    c_pannable(true)
